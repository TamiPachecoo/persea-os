...
function renderResult() {
  ...
  app.innerHTML = `
    <div class="screen">
      ...
      ${result.main_opportunity ? `<p class="opportunity-note">Principal oportunidade: <strong>${result.main_opportunity}</strong></p>` : ''}
      <p class="lede" style="margin-top:24px;">Seu resultado mostra onde sua percepção de valor está forte e onde existe espaço para evolução.</p>
      <p class="lede">Se quiser entender o que esses números significam especificamente para o seu posicionamento e quais movimentos podem aumentar sua percepção de valor, você pode solicitar uma análise estratégica personalizada.</p>
      <div class="nav-row" style="justify-content:flex-start;">
